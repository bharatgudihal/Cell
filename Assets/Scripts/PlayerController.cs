...
public class PlayerController : MonoBehaviour
{
	...
	Animator playerAnim;
//a reference for the players animations
	public float forwardSpeed;
//the move speed of the player
	float forwardInput;
//member variable for the forwardInput
	float turnInput;
//member variable for our turnInput
	float vel1 = 0f;
	float vel2 = 0f;
	bool cameraMoving;
...
// this is a carry over from a tutorial i found. it was used in the snap method I wanted to use.
	...
	private void Update ()
	{
		if (!stop) {
			...
			playerAnim.SetFloat ("forwardInput", Mathf.Abs (forwardInput));
